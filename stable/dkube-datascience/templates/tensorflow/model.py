...
if production != "false":
  ...
  def logger_hook(args, every_n_iter):
    args.pop("steps_epoch")
    args.pop("mode")
    hook = tf.train.LoggingTensorHook (args, every_n_iter=every_n_iter)
    return hook
...
def main(unused_argv):
  ...
  if production != "false" and os.getenv('TF_CONFIG','') != '':
